...
#ifndef SKETCHER_SUMEXPRESSION_H_
#define SKETCHER_SUMEXPRESSION_H_
...
protected:
	argument_list_type addition_arguments;
	argument_list_type subtract_arguments;
	std::vector<int> argument_ordering;
};

} // namespace SketcherExpressions

#endif /* SKETCHER_SUMEXPRESSION_H_ */
