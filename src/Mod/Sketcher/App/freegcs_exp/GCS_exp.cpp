...
{
    ConstraintInfo *constr = new ConstraintInfoPointOnEllipse(p, e);
    constr->setTag(tagId);
    return addConstraint(constr);
}
...
{
    ConstraintInfo *constr = new ConstraintInfoEllipticalArcRangeToEndPoints(p,a,angle);
    constr->setTag(tagId);
    return addConstraint(constr);
}
...
{
    ConstraintInfo *constr = new ConstraintInfoPointOnEllipse(p, a);
    constr->setTag(tagId);
    return addConstraint(constr);
}
...
{
    ConstraintInfo *constr = new ConstraintInfoEllipseTangentLine(l, e);
    constr->setTag(tagId);
    return addConstraint(constr);
}
...
{
    ConstraintInfo *constr = new ConstraintInfoEllipseTangentLine(l, a);
    constr->setTag(tagId);
    return addConstraint(constr);
}
...
int System::addConstraintTangentLine2ArcOfEllipse(
		Point& p1,
		Point& p2,
		Line& l,
		ArcOfEllipse& a,
...
int System::addConstraintTangentArcOfEllipse2Line(
		ArcOfEllipse& a,
		Line& l,
		Point& p1,
		Point& p2,
...
int System::addConstraintEqualRadii(Ellipse &e1, Ellipse &e2, int tagId)
{
    ...
    ConstraintInfo *constr = new ConstraintInfoEqualMajorAxesEllipse(e1,e2);
    constr->setTag(tagId);
    return addConstraint(constr);
}
...
int System::addConstraintEqualRadii(ArcOfEllipse &a1, ArcOfEllipse &a2, int tagId)
{
    ...
    ConstraintInfo *constr = new ConstraintInfoEqualMajorAxesEllipse(a1,a2);
    constr->setTag(tagId);
    return addConstraint(constr);
}
...
int System::addConstraintEqualRadii(ArcOfEllipse &a1, Ellipse &e2, int tagId)
{
    ...
    ConstraintInfo *constr = new ConstraintInfoEqualMajorAxesEllipse(a1,e2);
    constr->setTag(tagId);
    return addConstraint(constr);
}
...
{
    ConstraintInfo *constr = new ConstraintInfoInternalAlignmentPoint2Ellipse(e, p1, alignmentType);
    constr->setTag(tagId);
    return addConstraint(constr);
}
...
{
    ConstraintInfo *constr = new ConstraintInfoInternalAlignmentPoint2Ellipse(a, p1, alignmentType);
    constr->setTag(tagId);
    return addConstraint(constr);
}
